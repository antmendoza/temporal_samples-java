...
public class HelloTestSleepAndContinueAsNewTest {
    ...
    public void testActivityImpl() {
        ...
        testWorkflowRule.getWorker().registerActivitiesImplementations(new HelloTestSleepAndContinueAsNew.GreetingActivitiesImpl());
        ...
        assertEquals(
                ...
                describeWorkflowExecution(execution, namespace)
