 ...
 */
public class HelloChildContinue {
  ...
  public interface GreetingChild {
     ...
     */
    @WorkflowMethod
    String composeGreeting(int numIteration);
  }
  ...
  public static class GreetingChildImpl implements GreetingChild {
    ...
    private Logger logger = Workflow.getLogger(GreetingChildImpl.class);

    @Override
    public String composeGreeting(int iteration) {
